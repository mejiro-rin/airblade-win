...
public sealed class LocalizationService
{
    ...
    private static readonly Dictionary<string, (string Chinese, string English)> Texts = new(StringComparer.Ordinal)
    {
        ...
        ["Settings.About.CopyrightDescription"] = ("© {0} AirBlade 贡献者，保留所有权利。", "© {0} AirBlade contributors. All rights reserved."),
        ["Settings.About.Repository"] = ("代码仓库", "Repository"),
        ["Settings.About.Privacy"] = ("隐私", "Privacy"),
        ["Settings.About.PrivacyDescription"] = (
            "AirBlade 不会收集、上传或出售你的任何个人数据。设备列表、配对信息和设置仅保存在本机。仅在点击“检查更新”时，应用会向 GitHub 请求版本信息，该请求不含任何个人数据。",
            "AirBlade does not collect, upload, or sell any of your personal data. Your device list, pairing info, and settings stay on this device. Only when you click 'Check for updates' does the app request version info from GitHub; that request contains no personal data."),
        ["Settings.About.OpenSourceLicenses"] = ("开源许可", "Open source licenses"),
        ["Settings.About.OpenSourceLicensesDescription"] = ("本应用基于多种开源组件构建，点击查看完整许可清单", "This app is built on open source components. Click to view the full license list"),
        ["Settings.About.CheckForUpdates"] = ("检查更新", "Check for updates"),
        ["Settings.About.CheckForUpdatesDescription"] = ("点击检查 GitHub Releases 上是否有新版本", "Check GitHub Releases for a newer version"),
        ["Settings.About.CurrentVersion"] = ("当前版本 {0}", "Current version {0}"),
        ["Settings.About.Checking"] = ("正在检查…", "Checking…"),
        ["Settings.About.UpToDate"] = ("已是最新版本 {0}", "You are up to date ({0})"),
        ["Settings.About.FoundNewVersion"] = ("发现新版本 {0}", "New version available: {0}"),
        ["Settings.About.NoReleases"] = ("暂无发布版本", "No releases yet"),
        ["Settings.About.CheckFailed"] = ("检查失败，请稍后重试", "Check failed. Please try again later"),
        ["Settings.About.GoDownload"] = ("前往下载", "Go to download"),
        ["Settings.About.CopyDiagnostics"] = ("诊断信息", "Diagnostics"),
        ["Settings.About.CopyDiagnosticsDescription"] = ("复制系统与应用信息，便于反馈问题时粘贴", "Copy system and app info for pasting into bug reports"),
        ["Settings.About.ReportIssue"] = ("报告问题", "Report an issue"),
        ["Settings.About.ReportIssueDescription"] = ("在 GitHub Issues 中提交反馈", "Open GitHub Issues to submit feedback"),
        ["Settings.About.Copied"] = ("已复制到剪贴板", "Copied to clipboard"),
        ["Settings.About.Open"] = ("打开", "Open"),
        ["Settings.About.View"] = ("查看", "View"),
        ["Settings.About.Copy"] = ("复制", "Copy"),
        ["Settings.About.Close"] = ("关闭", "Close"),
        ["Settings.About.LicensesError"] = ("无法读取第三方许可证文件。", "Could not read the third-party licenses file."),
